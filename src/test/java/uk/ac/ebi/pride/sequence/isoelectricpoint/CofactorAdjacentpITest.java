 ...
 */
 ...
 public class CofactorAdjacentpITest {
    ...
    * It use the Cofactor algorithm with defaults settings (default factor correction).
    * */
    @Test
   ...
   * */
    ...
    public void testComputePIGroup() throws Exception {
        ...
        URL url = CofactorAdjacentpITest.class.getClassLoader().getResource("HellerDataSet.csv");
        if (url == null) {
    ...
    * */
    ...
    public void testComputePiFromPIPDB () throws Exception {
        ...
        URL url = CofactorAdjacentpITest.class.getClassLoader().getResource("PIPDB.txt");
        if (url == null) {
            throw new IllegalStateException("no file for input found!");
        }
        ...
        for(ProteinPIDB protein:proteinGroup){
            ...
            Double sequencesPI = calculator.computePI(sequence);
            System.out.println(protein.getHeaderForEntry()+ "\t" +protein.getSequenceProtein() + "\t" +protein.getpIexperimental()+ "\t" + df.format(sequencesPI));
        }
