...
/**
 * This class implement a JFormattedTextField which can be validated using any Format (i.e Number).
 * It can be useful to validate user input.
 */

public class ValidatorFormattedTextField extends JFormattedTextField {
    ...
    /**
     * Create a new {@code ValidatorFormattedTextField} instance which will use {@code aFormat} for the
     * validation of the user input.
     *
     * @param aFormat The format. May not be {@code null}
     */
    public ValidatorFormattedTextField(Format aFormat) {
     ...
     *
     * @param aFormat The format. May not be {@code null}
     * @param aValue  The initial value (or default too)
     */
    public ValidatorFormattedTextField(Format aFormat, Object aValue ) {
        this(aFormat);
        setValue(aValue);
    }
