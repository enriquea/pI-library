...
public class BjellpI implements IsoelectricPointMethod {
    ...
    public static String SKOOG_PKMETHOD      = "SKOOG_PKMETHOD";

    public static String EXPASY_PKMETHOD     = "EXPASY_PKMETHOD";

    public static String CALIBRATED_PKMETHOD = "CALIBRATED_PKMETHOD";
    ...
    public void setPkMethod(String pkMethod){
        if(pkMethod.equals(BJELL_PKMETHOD))
            defaultPkMethod  = BJELL_PKMETHOD;
        else if(pkMethod.equals(SKOOG_PKMETHOD))
            defaultPkMethod  = SKOOG_PKMETHOD;
        else if(pkMethod.equals(EXPASY_PKMETHOD))
